...
# by using the Elo formula to predict the outcome of all win/loss matches played in 2013
...
for line in f:
   ...
   if pagerank_prediction == fide_prediction:
      continue
   total_predictions += 1
   if result == '1':
...
total_predictions = fide_correct_predictions + pagerank_correct_predictions
