...
# runs the original Google PageRank algorithm
# on the chess games played by the current top 50 chess grandmasters in 2012
#
...
x = numpy.random.rand(1, num_players)[0]
x = [item / (1.0 * sum(x)) for item in x]
